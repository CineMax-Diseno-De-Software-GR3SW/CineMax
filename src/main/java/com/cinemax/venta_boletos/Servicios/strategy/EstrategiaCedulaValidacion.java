...
public class EstrategiaCedulaValidacion implements EstrategiaValidacion{
     ...
     * 
     * Punto de entrada principal que limpia espacios y delega 
     * la validación al método interno validarCedula().
     * 
     ...
     * 
     * @param cedula Número de cédula sin espacios
     * @return true si cumple todas las validaciones, false en caso contrario
     */
    private boolean validarCedula(String cedula) {
        ...
        try {
            ...
            boolean validacionFinal = cedula.substring(9, 10).equals(decimoDigitoCalculado);
            ...
            System.out.println("Validación final: décimo digito calculado-> " + decimoDigitoCalculado + 
                             ", décimo digito ingresado-> " + cedula.substring(9, 10) + 
